...
func (s *Sender) HandleChatJoinRequest(ctx context.Context, b *bot.Bot, update *models.Update) {
	fmt.Println("chat join request for", update.ChatJoinRequest.From.ID, "from", update.ChatJoinRequest.Chat.ID, "with invite link", update.ChatJoinRequest.InviteLink.InviteLink)
